...
class team implements Comparable<team> {
	...
	public int compareTo(team o) {
		if (solved != o.solved) // can use this primary field to decide sorted
								// order
			return o.solved - solved; // ICPC rule: sort by number of problem
										// solved
...
class ch2_02_algorithm_collections {
	public static void main(String[] args) {
		...
		System.out.println("Trying to search for 77 in v, found at index = "
				+ pos); // output is -5 (explanation below)

		/*
		 * binarySearch will returns: index of the search key, if it is
		 * contained in the list; otherwise, (-(insertion point) - 1). The
